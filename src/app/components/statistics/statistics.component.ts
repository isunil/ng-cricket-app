...
export class StatisticsComponent implements OnInit {
  ...
  private getTournamentDetails() {
    ...
    this.tournamentService.getTournamentData(year, gameType).subscribe(
      res => {
        this.details = res;
        const url = 'https://www.crichq.com/plugins/base?width=850&height=1080&border=1#competitions/'
          + this.details.competitionId + '/draws/' + this.details.drawId + '/leaderboards';
